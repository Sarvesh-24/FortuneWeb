...
const Company = () => {
  ...
  return (
    <section
    id="company"
    className="about section mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-12 dark:bg-gray-900"
  >
  {/* Header */}
...
{/* Content */}
<div className="flex flex-col lg:flex-row items-start gap-8 px-4 sm:px-8">
  {/* Right Section (Image) */}
  <div className="flex-1">
    <div className="relative w-full h-[500px] sm:h-[600px] lg:h-full">
      <img
...
<FloatingWhatsApp
  ...
  messageDelay={2}
  darkMode={true}  // Set darkMode to true for floating WhatsApp
  allowClickAway={true}
  allowEsc={true}

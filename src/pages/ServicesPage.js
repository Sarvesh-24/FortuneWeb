...
const ServicesPage = () => {
  return (
    ...
    <div className="bg-gray-100 dark:bg-gray-900 about section mx-auto w-full px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 rounded-xl shadow-lg">
  <div className="text-center mb-16">
    <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-4">
      Capturing Big Moves & Still Making Losses?{' '}
      <span className="text-red-600 dark:text-red-400">STOP CHASING RETURNS</span>
    </h1>
    <p className="text-lg text-gray-700 font-semibold dark:text-gray-300 mb-6">
      Capture Big Moves In All Time Frames With Exact Entry, Target & Stop Loss. Time Big Market Moves In Advance With the <span className="text-blue-600 dark:text-blue-400 font-semibold">#1 Time Trade Technique.</span>
    </p>
    <p className="text-lg text-gray-700 font-semibold dark:text-gray-300">

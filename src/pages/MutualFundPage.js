...
const MutualFundPage = () => {
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-blue-50 via-white to-blue-100 min-h-screen text-gray-800"
      id='mutualfunds'
    >
      {/* Hero Section */}
      <section className="bg-blue-600 text-white text-center py-16 mt-24">
        <h1 className="text-4xl md:text-5xl font-bold">Crafting Your Investment Future</h1>

...
> 
  ...
  {/* Benefits Section */}
  <section className="py-12 px-6 md:px-20 mt-0 dark:bg-gray-900 text-[#444444] dark:text-gray-300 font-roboto transition-colors duration-300">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    ...
    >
      <div className="flex items-center mb-4">
        <HiOutlineCash className="w-8 h-8 text-blue-500 dark:text-blue-300 mr-4" />
        <h3 className="text-xl font-semibold text-blue-500 dark:text-blue-400">Diversification</h3>
      </div>
    ...
    >
      <div className="flex items-center mb-4">
        <HiOutlineCurrencyDollar className="w-8 h-8 text-blue-500 dark:text-blue-300 mr-4" />
        <h3 className="text-xl font-semibold text-blue-500 dark:text-blue-400">Tax Benefits</h3>
      </div>
      <p className="text-gray-800 dark:text-gray-200">
    ...
    >
      <div className="flex items-center mb-4">
        <HiOutlineChartBar className="w-8 h-8 text-blue-500 dark:text-blue-300 mr-4" />
        <h3 className="text-xl font-semibold text-blue-500 dark:text-blue-400">Sector-Specific Investing</h3>
      </div>
      <p className="text-gray-800 dark:text-gray-200">
...
<section className="bg-blue-50 dark:bg-gray-800 py-12 px-6 md:px-20 mt-0 dark:bg-gray-900 text-[#444444] dark:text-gray-300 font-roboto transition-colors duration-300">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
    ...
    >
      <div className="flex items-center mb-4">
        <HiOutlineCash className="w-8 h-8 text-blue-500 dark:text-blue-300 mr-4" />
        <h3 className="text-xl font-semibold text-blue-500 dark:text-blue-400">Lumpsum</h3>
      </div>
      <p className="text-gray-800 dark:text-gray-200">
    ...
    >
      <div className="flex items-center mb-4">
        <HiOutlineSwitchHorizontal className="w-8 h-8 text-blue-500 dark:text-blue-300 mr-4" />
        <h3 className="text-xl font-semibold text-blue-500 dark:text-blue-400">Switch</h3>
      </div>
      <p className="text-gray-800 dark:text-gray-200">
    ...
    >
      <div className="flex items-center mb-4">
        <HiOutlineClock className="w-8 h-8 text-blue-500 dark:text-blue-300 mr-4" />
        <h3 className="text-xl font-semibold text-blue-500 dark:text-blue-400">SIP (Systematic Investment Plan)</h3>
      </div>
      <p className="text-gray-800 dark:text-gray-200">
    ...
    >
      <div className="flex items-center mb-4">
        <HiOutlineArrowRight className="w-8 h-8 text-blue-500 dark:text-blue-300 mr-4" />
        <h3 className="text-xl font-semibold text-blue-500 dark:text-blue-400">STP (Systematic Transfer Plan)</h3>
      </div>
      <p className="text-gray-800 dark:text-gray-200">
    ...
    >
      <div className="flex items-center mb-4">
        <HiOutlineCurrencyDollar className="w-8 h-8 text-blue-500 dark:text-blue-300 mr-4" />
        <h3 className="text-xl font-semibold text-blue-500 dark:text-blue-400">SWP (Systematic Withdrawal Plan)</h3>
      </div>
      <p className="text-gray-800 dark:text-gray-200">

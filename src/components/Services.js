...
const Services = () => {
  return (
    <section id='services' className="about section mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 font-roboto text-[#444444] dark:bg-gray-900 dark:text-gray-300">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-lg border p-6 shadow-lg hover:shadow-xl transition dark:bg-gray-800 dark:text-white dark:border-gray-700">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Live Trading Mentorship Programs</h3>
          ...
          <div className="rounded-lg border p-6 shadow-lg hover:shadow-xl transition dark:bg-gray-800 dark:text-white dark:border-gray-700">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Time Trading Technique</h3>
            <p className="text-gray-600 mb-4 dark:text-gray-400">
...
<h3 className="text-xl font-semibold mb-2 dark:text-white">Financial Planning</h3>
          ...
          <div className="rounded-lg border p-6 shadow-lg hover:shadow-xl transition dark:bg-gray-800 dark:text-white dark:border-gray-700">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Fortune Advisorz Live Events</h3>
            <p className="text-gray-600 mb-4 dark:text-gray-400">
              Attend our live events and seminars for advanced trading techniques and market insights.
            </p>
            <a href="#event" className="text-red-500 hover:underline font-medium dark:text-red-400 dark:hover:text-red-300">
              View Events →
            </a>
          </div>

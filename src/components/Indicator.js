...
const Indicator = () => {
  ...
  return (
    <section
      id="about"
      className="about section mx-auto max-w-screen-xl px-6 py-16 sm:px-6 lg:px-8 font-roboto bg-white dark:bg-gray-900 text-[#444444] dark:text-gray-100 transition-colors duration-300"
    >
      {/* Section Title */}
      <h2 className="text-3xl md:text-4xl font-bold text-[#384f4b] dark:text-gray-100 text-center mb-4 font-inter">
        Trade With Power Time Trading
      </h2>
              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative h-4 bg-gray-300 dark:bg-gray-700 rounded-md">
                    <div
                      className="absolute top-0 left-0 h-full bg-blue-500 dark:bg-blue-400 rounded-md progress-bar"
                      data-progress="70"
                    ></div>

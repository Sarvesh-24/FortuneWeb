...
const Gallery = () => {
  ...
  return (
    <section
      id="gallery"
      className="portfolio section mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 font-roboto bg-white dark:bg-gray-900 text-[#444444] dark:text-gray-100 transition-colors duration-300"
    >
